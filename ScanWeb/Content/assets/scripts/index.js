        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Meet LamipelVN!',
                    // (string | mandatory) the text inside the notification
                    text: 'LamipelVN is a brand new Responsive Admin Dashboard Template you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Buy LamipelVN!',
                    // (string | mandatory) the text inside the notification
                    text: 'LamipelVN comes with a huge collection of reusable and easy customizable UI components and plugins. Buy LamipelVN today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customize LamipelVN!',
                    // (string | mandatory) the text inside the notification
                    text: 'LamipelVN allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
