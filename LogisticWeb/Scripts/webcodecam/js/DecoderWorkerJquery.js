!function ($) {
    'use strict';
    $.fn.decodeworker = function () {
        debugger;
        var data = new decodeworker(this);
        return data;
    };
    $.fn.decodeworker.TwoOfFiveEncoding = ["00110", "10001", "01001", "11000", "00101", "10100", "01100", "00011", "10010", "01010"];
    $.fn.decodeworker.Code128Encoding = {
        "212222": {
            A: " ",
            B: " ",
            C: "00"
    ...
    $.fn.decodeworker.Code93Encoding = {
        "131112": {
            value: 0,
            character: "0"
        },
    ...
    $.fn.decodeworker.Code39Encoding = {
        "111221211": {
            value: 0,
            character: "0"
        },
    ...
    $.fn.decodeworker.ExtendedEncoding = {
        "/A": '!',
        "/B": '"',
        "/C": '#',
        "/D": '$',
    ...
    $.fn.decodeworker.CodaBarEncoding = {
        "0000011": "0",
        "0000110": "1",
        "0001001": "2",
        "1100000": "3",
    ...
    decodeworker.prototype = {
        ImgProcessing: function () {
        ...
        showImage: function (data, width, height) {
            postMessage({
                result: data,
                width: width,
                height: height,
        ...
        yStraighten: function (img, start, end) {
            var average = 0;
            var threshold;
        ...
        CheckEan13: function (values, middle) {
            if (middle) {
        ...
        TwoOfFiveStartEnd: function (values, start) {
        ...
        CheckInterleaved: function (values, start) {
            var average = 0;
            var i;
            for (i = 0; i < values.length; i++) {
                average += values[i];
        ...
        BinaryConfiguration: function (binaryString, type) {
            var result = [];
            var binTemp = [];
            var count = 0;
            var bars;
        ...
        BinaryString: function (img, type) {
            var binaryString = [];
            var binTemp = [];
            var container = 255;
            var count = 0;
        ...
        Distribution: function (totalBinArray, type) {
            var testData = 0;
            var result = [];
            var totalBars;
            var total;
        ...
        checkResultForEAN: function (resultArray) {
            var weight = 3;
            var sum = 0;
        ...
        checkFinalResult: function (result) {
    ...
    $.fn.DecodeWorker.Constructor = decodeworker;
    $(function () {
        //$('.popupjs').popup_js();
    });
}(window.jQuery);