...
var barcode_result = document.getElementById('BARCODE');
...
var decodeCallback = function (ptr, len, resultIndex, resultCount) {
    ...
    var codescanned = String.fromCharCode.apply(null, result);
    //console.log(codescanned);
    barcode_result.value = codescanned;
...
function scanBarcode() {
    ...
    if (ZXing == null) {
        ...
        //    type: 'error',
        //    title: 'Error',
        //    text: "Barcode Reader is not ready!"
        //});
